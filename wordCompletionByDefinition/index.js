...
const sheetName = "ListOfQuizesDefinition"; // Replace with the name of your sheet
...
function quizPage(sheetValue, quizType) {
  ...
  window.location.assign(
    "wordCompletionByDefinition.html?sheetName=" +
      sheetValue +
      "&quizType=" +
      quizType
  );
...
function learnPage(sheetValue, quizType) {
  //console.log(sheetValue);
  window.location.assign(
    "wordCompletionByDefinitionLearn.html?sheetName=" +
      sheetValue +
      "&quizType=" +
      quizType
  );
