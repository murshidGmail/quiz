...
const sheetName = "ListOfQuizesListening"; // Replace with the name of your sheet
...
function quizPage(sheetValue, quizType) {
  ...
  window.location.assign(
    "game.html?sheetName=" + sheetValue + "&quizType=" + quizType
  );
}
...
function learnPage(sheetValue, quizType) {
  //console.log(sheetValue);
  window.location.assign(
    "gameLearn.html?sheetName=" + sheetValue + "&quizType=" + quizType
  );
}
